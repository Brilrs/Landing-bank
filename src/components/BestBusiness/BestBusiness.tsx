        ...
        <div className="relative px-6 py-20 md:py-64" id="features">
            ...
            <div className="grid max-w-5xl mx-auto md:grid-cols-2">
                <div>
                    ...
                    <Reveal>
                        <p className="max-w-md mt-10">Con la tarjeta de crédito adecuada, puede mejorar su vidad
                            financiera generando crédito, obteniendo recompensas y ahorrando dinero. Pero con cientos
