    ...
    <div className="p-4 py-20 md:py-64">
        <div className="flex flex-col-reverse max-w-5xl mx-auto md:flex-row place-content-evenly">
            ...
            <div className="flex-1 p-6 md:p-8">
                <Reveal>
                    <h2 className="text-5xl font-semibol">
                ...
                <Reveal>
                    <p className="max-w-md mt-10">
                        Con la tarjeta de crédito adecuada, puede mejorar su vida financiera generando mejorar
                        su vida financiera generando crédito, obteniendo recompensas y ahorrando dinero.
                        Pero con cientos de tarjetas de créditop en el mercado
                    </p>
                </Reveal>
            </div>
        </div>
